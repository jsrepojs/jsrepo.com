...
When publishing your code to jsrepo it will exist forever on the jsrepo.com platform. It
will not be deleted unless it breaks our rules for unacceptable use.
...
By default jsrepo will only allow you to upload files with supported extensions. Circumventing this to host static assets from jsrepo is strictly forbidden.

### 1.2. Reporting registries

Please report any registries that break these rules through our [contact form](/help?reason=suspicious-registry).
...
If you are contacted by someone who is attempting to sell you a scope name, or buy a scope name from you, please report this to us through our [contact form](/help).
...
By default we have identified and banned certain scope, registry and org names from being used on our platform. Most of them are obviously inappropriate. However if we have made a mistake by disallowing your scope name or we have left something out please reach out through our [contact form](/help).
...
Purchasers of your registry will have lifetime, unlimited access to use your code in their projects. They are not allowed to redistribute your code publicly or for sale anywhere including jsrepo.com. If you notice someone redistributing code from your marketplace registry on jsrepo.com please [contact us](/help).
...
In the case of a registry that is not what it says it is you can report the registry and may be issued a refund if we find the registry to be fraudulent.
